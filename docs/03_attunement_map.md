...
状態間の移動や戻り方（遷移）は、  
[Patterns](../resources/patterns/README.md) および [Failure Modes](../docs/07_failure_modes.md) に委ねられている。
...
- [Failure Modes](./07_failure_modes.md)
...
### 位置の詳細について
- [Failure Modes](./07_failure_modes.md) — 乱れの典型
