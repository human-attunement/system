...
- 「解決策」は提示しない（解決策を書いた瞬間、メソッド化してHASを破壊する）
...
### 最小の退避
- **Level 0に戻る:** 「私は今、沈黙を守ることに固執している」と認識する
...
### 最小の退避
- **Level 0は正規の実践:** 何もしないことは責任放棄ではない
- **熟練の定義を想起:** 高位維持ではなく、戻れること
- **Armorの自己点検:** 「完璧主義自体が防衛では？」
- **docs/08_exit_and_unsuitability.mdを参照（長期検討文書）**
...
- **governance/protocols/public_relations.mdを参照**
...
### 最小の退避
- **Level 0に戻る:** 「私は今、整っていない」と認識する
- **緊急停止を検討する:** 場を止める、または別の人に交代する
- **呼吸に留まる:** 何もせず、自分の呼吸だけを観る
- **Facilitator Pitfallsを参照:** 壊れやすいポイントを確認
