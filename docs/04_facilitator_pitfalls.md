...
詳細：[Failure Mode G: Facilitatorの状態無視](./07_failure_modes.md#failure-mode-g-facilitatorの状態無視)
...
詳細：[Failure Mode A: 沈黙の美化によるネグレクト](./07_failure_modes.md#failure-mode-a-沈黙の美化によるネグレクト)
...
詳細：[Failure Mode E: 完璧主義ループ](./07_failure_modes.md#failure-mode-e-完璧主義ループ自己監視の宗教化)
...
詳細：[Failure Mode D: Fear/Want判定の投影・診断化](./07_failure_modes.md#failure-mode-d-fearwant判定の投影診断化)
...
Level 0について詳しくは：[Attunement Levels](./03_attunement_levels.md#level-0観察モードobservation-mode)

---

## 関連文書

- [Attunement Levels](./03_attunement_levels.md) — Level 0の詳細
- [Failure Modes](./07_failure_modes.md) — 壊れ方のカタログ
