...
運営者は下記の文書を元に、HASの扱い、管理運営の参考にする。

- [緊急停止プロトコル](governance/protocols/emergency_stop.md)
- [世話人の判断プロトコル](governance/protocols/steward_judgment.md)
- [メンテナンスプロトコル](governance/protocols/maintainance.md)
- [広報プロトコル](governance/protocols/public_relations.md)
- [リソース管理プロトコル](governance/protocols/resource_process_minimal.md)
